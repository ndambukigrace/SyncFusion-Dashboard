...
import commas from '../data/commas.jpeg'
  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        <div className='bd-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl
        ...
        >
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-2xl'>$63,448.89</p>
            </div>
          </div>
